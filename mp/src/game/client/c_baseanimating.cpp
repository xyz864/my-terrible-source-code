...
ConVar cl_raglife("cl_raglife", "20", FCVAR_ARCHIVE, "Set how much time the ragdolls are going to stay before they fade out");
...
m_iCurrentFriction = 0;
	...
	m_flFadeOutDelay = gpGlobals->curtime + cl_raglife.GetFloat();
