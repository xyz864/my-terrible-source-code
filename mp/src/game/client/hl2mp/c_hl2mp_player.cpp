...
END_PREDICTION_DATA()
#define	HL2_WALK_SPEED 50
#define	HL2_NORM_SPEED 100
#define	HL2_SPRINT_SPEED 0

static ConVar cl_playermodel( "cl_playermodel", "none", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_SERVER_CAN_EXECUTE, "Default Player Model");
static ConVar cl_defaultweapon( "cl_defaultweapon", "weapon_ar2", FCVAR_USERINFO | FCVAR_ARCHIVE, "Default Spawn Weapon");
...
LINK_ENTITY_TO_CLASS(hl2mp_ragdoll, C_HL2MPRagdoll);
...
void C_HL2MPRagdoll::CreateHL2MPRagdoll( void )
{
	...
	if ( pPlayer && !pPlayer->IsDormant() )
	{
		...
		else
		{
			...
			SetCycle( 0.0 );
			SetBodygroup(1, 1);
	//		SetBodygroup(3, 0); //rarm
		//	SetBodygroup(4, 0); //rleg
		//	SetBodygroup(5, 0); //lleg
	//		SetBodygroup(6, 0); //larm
