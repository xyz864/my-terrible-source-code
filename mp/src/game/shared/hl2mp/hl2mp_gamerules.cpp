...
static HL2MPViewVectors g_HL2MPViewVectors(
	Vector( 0, 0, 39 ),       //VEC_VIEW (m_vView) 
							  
	Vector(-12, -12, 0 ),	  //VEC_HULL_MIN (m_vHullMin)
	Vector( 12,  12,  56 ),	  //VEC_HULL_MAX (m_vHullMax)
							  					
	Vector(-12, -12, 0 ),	  //VEC_DUCK_HULL_MIN (m_vDuckHullMin)
	Vector( 12,  12,  36 ),	  //VEC_DUCK_HULL_MAX	(m_vDuckHullMax)
...
CAmmoDef *GetAmmoDef()
{
	...
	if ( !bInitted )
	{
		...
		def.AddAmmoType("AR2",				DMG_BULLET,					TRACER_LINE_AND_WHIZ,	0,			0,			270,			BULLET_IMPULSE(200, 1225),	0 );
		...
		def.AddAmmoType("SMG1",				DMG_BULLET,					TRACER_LINE_AND_WHIZ,	0,			0,			320,		BULLET_IMPULSE(200, 1225),	0 );
